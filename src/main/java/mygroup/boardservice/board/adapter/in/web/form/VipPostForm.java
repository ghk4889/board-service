...
//    @Builder
    ...
    public static class Request {
        ...
        /* Dto -> Entity */
        public VipPostSaveDto toSaveEntity() {
            return new VipPostSaveDto(title, content, writer, 0
                    , new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis()));

        }
        /* Dto -> Entity */
        public VipPostUpdateDto toUpdateEntity(){
            return new VipPostUpdateDto(id, title, content, new Date(System.currentTimeMillis()));
